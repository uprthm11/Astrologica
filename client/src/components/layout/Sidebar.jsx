...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const { activeTab, setActiveTab, astrologyData, mbtiData, adminToken } = useAppStore()
      ...
      >
        ...
        <div>
          <div className="p-5 border-b border-[#262a63] flex items-center justify-between">
            ...
            <button
              onClick={() => setIsOpen(false)}
              className="lg:hidden p-1.5 rounded-lg bg-[#161942] text-[#7b82b8] hover:text-white cursor-pointer"
            >
              ✕
            </button>
          </div>
          ...
          <div className="p-4 space-y-6">
            <div>
              ...
              <nav className="space-y-1.5">
                {navItems.map((item) => {
                  const isActive = !isDossierPage && !isAdminPage && activeTab === item.id
                  ...
                  return (
                    <Link
                      ...
                      className={`w-full text-left px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all flex items-center justify-between cursor-pointer group relative ${
                        isActive
            ...
            <div>
              ...
              <div className="space-y-1.5">
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-[#141842] text-[#00d2ff] flex items-center justify-center shrink-0">
                  ...
                  <div className="min-w-0 text-left">
                    ...
                    <div className="text-[10px] font-mono text-[#6b729f]">
                      {adminToken ? 'Authenticated' : 'Terminal Gateway'}
                    </div>
                  </div>
                </Link>
              </div>
          ...
          <div className="p-3 rounded-xl bg-[#141842] border border-[#262a63] space-y-2">
            ...
            <div className="text-[10px] font-mono text-[#7b82b8] space-y-0.5">
              <div className="flex justify-between">
                ...
                <span className="text-[#00d2ff]">v2.2.0</span>
              </div>
              <div className="flex justify-between">
                <span>Ephemeris Core</span>
